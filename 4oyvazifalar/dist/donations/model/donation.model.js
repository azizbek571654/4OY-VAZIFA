...
], Donation.prototype, "supporter_id", void 0);
__decorate([
...
], Donation.prototype, "admin", void 0);
__decorate([
    (0, sequelize_typescript_1.ForeignKey)(() => admin_model_1.Admin),
    (0, sequelize_typescript_1.Column)({
        type: sequelize_typescript_1.DataType.BIGINT,
    ...
    __metadata("design:type", Number)
], Donation.prototype, "creator_id", void 0);
__decorate([
    (0, sequelize_typescript_1.BelongsTo)(() => admin_model_1.Admin, {
        onDelete: 'CASCADE',
        onUpdate: 'CASCADE',
    ...
    __metadata("design:type", admin_model_1.Admin)
], Donation.prototype, "admin2", void 0);
__decorate([
    (0, sequelize_typescript_1.Column)({
...
__decorate([
    ...
    __metadata("design:type", String)
], Donation.prototype, "payment_method", void 0);
exports.Donation = Donation = __decorate([
    (0, sequelize_typescript_1.Table)({ tableName: 'Donations' })
], Donation);

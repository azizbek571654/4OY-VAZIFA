...
const category_model_1 = require("../../dist/categories/model/category.model");
...
exports.SocialModule = SocialModule = __decorate([
    (0, common_1.Module)({
        imports: [sequelize_1.SequelizeModule.forFeature([social_model_1.Social, category_model_1.Category]), categories_module_1.CategoriesModule],
